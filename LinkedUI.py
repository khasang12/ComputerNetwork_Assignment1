...
import server
from utils.peer import Peer_Central
...
class FirstPage(Tk):
    def __init__(self):
        ...
        # Homepage - logo
        img = PIL.ImageTk.PhotoImage(PIL.Image.open(os.path.join(os.getcwd(),'./utils/logo.png')).resize((560,420)))        # chỗ này t bị lỗi import ko được ImageTk
